...
class RewardModelWrapper(gym.Wrapper):
    ...
    def __init__(self, env, reward_model, reward_model_kwargs={"action_dependent": False}):
        super().__init__(env)
    ...
    def update_reward_model(self, reward_model, reward_model_kwargs={"action_dependent": False}):
        self.reward_model = reward_model
        self.reward_model_kwargs = reward_model_kwargs
...
class DictToMultiDiscreteActionSpace(gym.Wrapper):
    ...
    def __init__(self, env, minerl_agent=None):
        ...
        agent_action = self.minerl_agent._env_action_to_agent(
            random_env_action)
    ...
    def to_array_action(self, agent_action):
        ...
        elif isintance(agent_action["camera"], th.Tensor):
            array_action = th.cat(
    ...
    def to_agent_action(self, array_action):
        agent_action = {
            "camera": array_action[..., 0], "buttons": array_action[..., 1]}
        return agent_action
