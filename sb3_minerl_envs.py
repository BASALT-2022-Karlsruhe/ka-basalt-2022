...
from gym_wrappers import DictToMultiDiscreteActionSpace, HiddenStateObservationSpace
...
for env_name in ["FindCave", "MakeWaterfall", "BuildVillageHouse", "CreateVillageAnimalPen"]:
    register(
